...
namespace ProseTutorial
{
    internal class Program
    {
        private static readonly Grammar Grammar = DSLCompiler.Compile(new CompilerOptions
        {
            ...
            InputGrammarText = File.ReadAllText("synthesis/grammar/concat.grammar"),
...
3 - exit";
        ...
        {
            Console.Out.Write("Provide a new input-output example (e.g., \"(Sumit Gulwani)\",\"Gulwani Sumit\"): ");
            try
            {
